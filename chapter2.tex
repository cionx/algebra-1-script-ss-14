...
\begin{defi}
 $\lambda = (\lambda_1, \dotsc, \lambda_s) \in \N^s$ is a partition of $|\lambda| \coloneqq \sum_{i=1}^s \lambda_i$ if
 \[
  \lambda_1 \geq \lambda_2 \geq \dotsb \geq \lambda_s \geq 0.
 \]
 The $\lambda_i$ are the parts of $\lambda$ and $l(\lambda) \coloneqq s$ is the length of  $\lambda$.
