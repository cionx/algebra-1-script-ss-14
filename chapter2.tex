...
\begin{expl}
 ...
 \]
 We also set $e_0^{(n)} := 1$ and $e_r^{(n)} = 0$ for $r > n$. (We will generalize $m_\lambda$ later on.)
\end{expl}
...
\begin{expls}
 ...
 The partitions
 \[
  \yng(2,2) \quad \text{and} \quad \yng(1,1)
 \]
 are not comparable (because $4 \neq 2$ in $\N$). The partitions
 \[
  \yng(4,2,1,1,1) \quad \text{and} \quad \yng(3,3,2,1)
 \]
