...
\begin{example}
  ...
  Let $n \geq 2$ and let the symmetric group $S_n$ acts on $k^n$ via
  \[
  ...
  We do so by determining all subrepresentations of~$V$.
  ...
  Note that the existence of $U_1$ and $U_2$ already shows that $V$ itself is reducible.
  ...
  \begin{itemize}
    ...
    \item
      ...
      Then $v = (x_1, x_2, x_3, \dotsc, x_n)$ and $(1\,2).v = (x_2, x_1, x_3, \dotsc, x_n)$, hence
      \[
            v - (1\,2).v
      ...
      \]
      are contained in $U$.
      It follows that $U_2 \subseteq U$ because these vectors form a $k$-basis of the subrepresentation $U_2$.
...
% TODO: Give lattice of subrepresentations.
\end{example}
...
%       This is not a complete coincidence:
  \end{enumerate}
\end{example}
