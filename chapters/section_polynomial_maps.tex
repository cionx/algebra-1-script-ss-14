...
% TODO (optional): Definition of P(V) without basis as S(V*)
  ...
  \begin{enumerate}
    ...
    \item
      ...
      \[
        ...
        = \sum_{\mindex{i}} \lambda_{i_1} \dotsm \lambda_{i_r} v_{\mindex{i}} \,.
      \]
      For the polynomials $p_{\mindex{i}} \defined  X_{i_1} \dotsm X_{i_r}$ and their corresponding polynomial maps $f_{\mindex{i}} \colon V \to k$ given by
      \[
          f_{\mindex{i}}\left( \lambda_1 v_1 + \dotsb + \lambda_n v_n \right) = p_{\mindex{i}}(\lambda_1, \dotsc, \lambda_r)
      \]
      we thus have that $f(v) = \sum_{\mindex{i}} f_{\mindex{i}}(v) v_{\mindex{i}}$ for every $v \in V$.
  \end{enumerate}
\end{example}
