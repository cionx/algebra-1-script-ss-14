...
\begin{recall}
  ...
  Note that for the uniqueness of the decomposition $x = \sum_{j \in J} w_j \otimes v_j$ it sufficies that $(w_j)_{j \in J}$ in linearly independent, because we can then set $W = \gen{w_j \suchthat j \in J}_k$ and use the above result.
