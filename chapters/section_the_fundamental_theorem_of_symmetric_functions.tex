...
\begin{proof}[First proof of the fundamental theorem]
  ...
  For this we notice that for all $\mindex{\alpha} \neq \mindex{\beta}$ we have that
  \begin{align*}
            \init e^{\,\mindex{\alpha}}
    ...
    \neq&\, X_1^{\beta_1 + \dotsb + \beta_n}   X_2^{\beta_2  + \dotsb + \beta_n}  \dotsm X_n^{\beta_n}  \\
       ...
       =    \init e^{\,\mindex{\beta}}
  \end{align*}
  so that the polynomials $e^{\,\mindex{\alpha}}$ for $\mindex{\alpha} \in \Natural^n$ are pairwise different.
  
  Now suppose that
  \[
      0
    = \lambda_1 e^{\,\mindex{\alpha}_1} + \dotsb + \lambda_s e^{\,\mindex{\alpha}_s}
  \]
  with $s \geq 1$, $\mindex{\alpha}_i \neq \mindex{\alpha}_j$ for $i \neq j$ and $\lambda_i \neq 0$ for all $1 \leq i \leq s$.
  We can assume w.l.o.g.\ that 
  \[
      \init e^{\,\mindex{\alpha}_1}
    > \init e^{\,\mindex{\alpha}_2}
    > \dotsb
    > \init e^{\,\mindex{\alpha}_s}
  \]
  since all of these terms are pairwise different.
  It follows that the initial term $\init e^{\,\mindex{\alpha}_1}$ occures only in $e^{\,\mindex{\alpha}_1}$ and in no ther of the $e^{\,\mindex{\alpha}_i}$.
...
\begin{proof}[Second proof of the fundamental theorem]
  ...
  \begin{proof}[Proof of claim]
    ...
    \begin{proof}
      ?
%     TODO (optional): Figuring out why.
    \end{proof}
