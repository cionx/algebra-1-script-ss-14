...
\begin{corollary}
  ...
  \begin{align*}
    ...
    \in&\,    X^{n(1,\dotsc,\ell)} D^{m(1,\dotsc,\ell)}
            + F'_{n(1,\dotsc,\ell) + m(1,\dotsc,\ell) - 1}(\weyl')
  \end{align*}
\end{corollary}
...
\begin{fluff}
  ...
  This shows that the filtration $F$ of $\weyl$ does not come from a filtration of $\weyl$, and it follows from Lemma~\ref{lemma: associated graded reflects no zero divisors} that $\weyl$ has no zero divisors.
\end{fluff}
