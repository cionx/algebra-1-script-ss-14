...
\begin{remark}
  Instead of the natural numbers $\Natural$ one can also define gradings over an arbitrary monoids $(M, \cdot)$, but we will not need this.
\end{remark}
...
\begin{example}
  ...
  \begin{enumerate}
    \item
      ...
      Every grading $A = \bigoplus_{d \in \Natural} A_d$ of $A$ leads to a filtration $F$ of $A$ given by $F_d \defined \bigoplus_{i=0}^d A_i$ for every $d$.
    \item
