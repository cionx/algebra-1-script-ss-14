...
\begin{remark}
  ...
  We will come back to this idea in Remark~\ref{remark: bilinear form on characters is bilinear extension of hom} when we encounter characters of representations.
\end{remark}
