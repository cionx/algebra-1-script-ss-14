...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    \item
      ...
      \[
          \varphi(a \otimes b^\op)(x)
        = (f(a) \circ g(b^\op))(x)
        = a x b
      \]
      for all $a \otimes b^\op \in A \otimes A^\op$, $x \in A$.
      For all simple tensors $a_1 \otimes b_1^\op, a_2 \otimes b_2^\op \in A \otimes A^\op$ we have that
      \begin{align*}
            \varphi(a_1 \otimes b_1^\op) \varphi(a_2 \otimes b_2^\op)
        &=  f(a_1) \circ g(b_1^\op) \circ f(a_2) \circ g(b_2^\op) \\
        &=  f(a_1) \circ f(a_2) \circ g(b_1^\op) \circ g(b_2^\op  \\
        &=  f(a_1 a_2) \circ g(b_1^\op b_2^\op)                   \\
        &=  \varphi((a_1 a_2) \otimes (b_1^\op b_2^\op))          \\
        &=  \varphi((a_1 \otimes b_1^\op) (a_2 \otimes b_2^\op))
      \end{align*}
