...
\begin{proof}[Alternative proof]
  ...
  Then for $D \defined \End_R(M)$ we may represent $f$ as a matrix $A \in \Mat(n' \times n, D)$ (see Appendix~\ref{appendix: homomorphisms between direct sums}) and $f^{-1} \colon E^{\oplus n'} \to E^{\oplus n}$ as a matrix $B \in \Mat(n \times n', D)$.
