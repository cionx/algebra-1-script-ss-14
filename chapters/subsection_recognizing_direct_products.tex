...
\begin{proof}
  ...
  Suppose that $M = M_1 \oplus \dotsb \oplus M_n$ for submodules $M_i \moduleeq M$.
  ...
  Let $M = M_1 \oplus \dotsb \oplus M_n$ be a decomposition into submodule $M_i \moduleeq M$ and let $(e_1, \dotsc, e_n)$ be the associated complete family of pairwise orthogonal idempotents.
