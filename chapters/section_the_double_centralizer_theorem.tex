...
% TODO: Does not hold for non ss modules.
...
% \begin{fluff}
%   It is worthwhile to point out that a similar result holds for $R$ itself:
% \end{fluff}
% 
% 
% \begin{lemma}
%   If $M$ is faithful as an $R$-module and $M = L_1 \oplus \dotsb \oplus L_n$ for (finitely many) simple $R$-modules $L_1, \dotsc, L_n$ then $R$ is semisimple.
% \end{lemma}
% 
% 
% \begin{proof}
