...
% \begin{remark}
%   Some people use the term \emph{quasi-compact} instead of \emph{compact}, reserving term \emph{compact} for (quasi-)compact Hausdorff spaces.
%   The above definition shows which convention the author of these notes uses.
% \end{remark}
% 
% 
% \begin{lemma}
...
% TODO: Every X is the union of finitely many irreducible subsets
...
% TODO: Remark about the spectrum of a topological ring
...
% TODO: Polynomial maps between affine varietes

% TODO: Coordinate Rings
