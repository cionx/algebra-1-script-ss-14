...
% 
% \begin{proof}
%   The group algebra $k[G]$ is finite-dimensional and by Maschke’s Theorem also semisimple.
%   Therefore
%   \[
%       |\Irr_k(G)|
%     = |\Irr(k[G])|
...
%     = \dim_k k[G]/[k[G], k[G]] \,.
%   \]
%   Since $G$ is abelian the group algebra $k[G]$ is commutative, so $[k[G],k[G]] = 0$ and
%   \[
%       \dim_k k[G]/[k[G], k[G]]
%     = \dim_k k[G]
%     = |G| \,.
