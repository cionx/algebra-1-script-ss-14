    ...
    \item
      ...
      \begin{itemize}
        ...
        \item
          ...
          Then there exists a decomposition $M_1 \boxplus M_2 = \bigoplus_{j \in J} L^j$ into simple submodules $L^j \moduleeq M_1 \boxplus M_2$.
          Every $L^j$ is of the form $L^j = L^j_1 \boxplus L^j_2$ for unique $R_i$-submodules $L^j_i \moduleeq M_i$ by Proposition~\ref{proposition: submodules of products over rings}.
...
\begin{proposition}[Skolem--Noether]
