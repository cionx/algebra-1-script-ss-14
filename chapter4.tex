...
\begin{prop}
 ...
 \]
 is an isomorphism of $k$-vector spaces, where
\end{prop}
\begin{proof}
 ...
 \]
 is well-defined and $k$-linear. Because $(-,-)$ is nondegenerate $\varphi$ is injective. Since $A$ is finite-dimensional we find that $\varphi$ is an isomorphism of $k$-vector spaces. To prove the proposition we show that $\varphi(z)_{|[A,A]} = 0$ if and only if $z \in Z(A)$.
