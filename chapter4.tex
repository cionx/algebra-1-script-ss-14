...
\begin{thrm}[Double centralizer theorem]
 Let $k$ be a field (not necessarily algebraically closed) and $W$ a finite-dimensional $k$-vector space. Let $A \subseteq \End_k(A)$ be a semisimple subalgebra. Let $A'$ be the commutant of $A$ in $\End_k(W)$, i.e.\
 \[
