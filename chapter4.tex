...
\begin{proof}[Proof of Artin--Wedderburn]
 ...
 \begin{align*}
  ...
  &\cong \End_R(n_1 V_1) \oplus \dotsb \oplus \End_R(n_r V_r) \\
  &\cong \Mat_{n_1}(D_1) \oplus \dotsb \oplus \Mat_{n_r}(D_r)
 \end{align*}
 as rings for the skew field $D_i \coloneqq \End_R(V_i)$. Therefore
 \begin{align*}
  R
  &\cong \left( R^\op \right)^\op \\
  &\cong \left( \Mat_{n_1}(D_1) \oplus \dotsb \oplus \Mat_{n_r}(D_r) \right)^\op \\
  &= \Mat_{n_1}(D_1)^\op \oplus \dotsb \oplus \Mat_{n_r}(D_r)^\op \\
  &\cong \Mat_{n_1}\left( D_1^\op \right) \oplus \dotsb \oplus \Mat_{n_r}\left( D_r^\op \right)
 \end{align*}
