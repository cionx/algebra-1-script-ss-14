...
Given $k$-algebras $A_1$ and $A_2$ then $A_1 \otimes_k A_2$ is a $k$-algebra via the multiplication
\[
...
\end{align*}
Since these simple tensors generate $L \otimes_k A$ it follows that $f_L$ is multiplicative.
