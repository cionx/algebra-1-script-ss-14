...
Given a $k$-algebra $A$ we get that $L \otimes_k A$ is an $L$-vector space and a $k$-algebra. It is easy to see that that these structures are compatible and give $L \otimes_k A$ the structure of an $L$-algebra. To see this compatibility simply notice that the $k$-bilinear map
\begin{align*}
 (A_1 \otimes_k A_2) \times (A_1 \otimes_k A_2) &\to A_1 \otimes_k A_2, \\
 (a_1 \otimes b_1, a_2 \otimes b_2) &\mapsto (a_1 a_2) \otimes (b_1 b_2).
\end{align*}
