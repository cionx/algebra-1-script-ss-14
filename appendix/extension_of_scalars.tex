...
Given $k$-algebras $A_1$ and $A_2$ we know that $A_1 \otimes_k A_2$ is a $k$-algebra via the multiplication
\[
 (a_1 \otimes a_2) \cdot (b_1 \otimes b_2) = (a_1 b_1) \otimes (a_2 b_2).
\]
...
For the $k$-algebra $k[X_1, \dotsc, X_n]$ this gives us an $L$-algebra
\[
